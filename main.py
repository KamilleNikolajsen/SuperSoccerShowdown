...
def print_teams():
    pokemon_team = team_generator.generate_team(fetch_data.fetch_pokemon, 'Pokemon Team', 5,
                                                    1, 100)
    display_team.display_team(pokemon_team)

    star_wars_team = team_generator.generate_team(fetch_data.fetch_person, 'Star Wars Team', 5,
                                                     1, 87)
